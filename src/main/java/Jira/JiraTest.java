...
public class JiraTest {
	public static void main(String []args) {
		...
		String response= given().header("Content-Type", "application/json").body("{ \"username\": \"santoshghodke88\",\r\n"
				+ " \"password\": \"Svg@8888\" }").log().all().filter(session).when().post("/rest/auth/1/session")
